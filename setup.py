...
def load_tests():
    import unittest
    from wolframengine.cli.commands.test import Command as TestCommand
    TestCommand().handle()

ABOUT = {}
with open(os.path.join(HERE, 'wolframengine', 'about.py'), 'r') as fp:
    exec(fp.read(), ABOUT)
...
setup(
    ...
    keywords=['Wolfram Language', 'Wolfram Desktop', 'Mathematica', 'Web Development', 'Wolfram Engine'],
    ...
    project_urls={
        'Source code': 'https://github.com/WolframResearch/WolframEngineForPython',
        'Documentation': 'https://wolfr.am/wolframenginedoc',
